...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" PageIndex="1" CssClass="table table-striped table-bordered table-hover" runat="server" PageSize="50" AllowPaging="true" OnRowCreated="GridView1_RowCreated" OnRowCommand="GridView1_RowCommand"></asp:GridView>
